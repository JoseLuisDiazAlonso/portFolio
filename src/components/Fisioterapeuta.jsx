    ...
    <section className='p-8 mx-auto text-white bg-gradient-to-b from-blue-900 via-blue-400 rounded-2xl shadow-log max-w-7xl'>
      <div className="flex flex-col items-start justify-start gap-4 mb-8 lg:flex-row lg:justify-between lg:items-center">
        ...
        <div className="flex justify-end pr-8">
          <button onClick={() => toggleLanguage && toggleLanguage()} className="relative z-10 flex items-center gap-2 px-3 py-1 text-sm text-white bg-blue-600 rounded-lg hover:bg-blue-700">
      ...
      <div className="flex flex-col items-center mb-8">
        <video src='/videos/Fisioterapeuta.mp4' controls autoPlay loop muted className="object-contain w-full max-w-4xl rounded-lg shadow-lg"/>
      </div>
