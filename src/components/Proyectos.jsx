...
const TRADUCCIONES = {
  ...
  en: {
    ...
    proyectos: [
      { id: 1, title: 'Samain', image: Samain, description: 'Website for the Cultural Association Tierraquemada', link: '/samain' },
...
const Proyectos = ({lang = "es"}) => {
  ...
  return (
    <section
      id='projects' 
      className='w-full max-w-6xl px-4 mx-auto overflow-x-hidden text-white bg-gray-800 shadow-lg sm:px-6 lg:px-8 backdrop-blur-md rounded-2xl'
    >
