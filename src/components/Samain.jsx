...
const Samain = ({ lang, toggleLanguage }) => {
  const textos = {
    es: (
      <>
        <p className='mb-4'>
          Samain es una página web impulsada por la Asociación Cultural Tierraquemada con el propósito de tender 
    ...
    en: (
      <>
        <p className='mb-4'>
          Samain is a website driven by the Asociación Cultural Tierraquemada with the purpose of building bridges between communities that share a common heritage: Celtic culture. 
